export default function FollowersLoading() {
  return (
    <div className="mx-auto max-w-2xl">
      ...
      {/* Tabs */}
      <div className="sticky top-[57px] z-10 flex border-b border-border bg-background/80 backdrop-blur">
        <div className="flex-1 py-3 text-center">
          <div className="mx-auto h-4 w-20 animate-pulse rounded bg-surface-hover" />
        </div>
        <div className="flex-1 py-3 text-center">
          <div className="mx-auto h-4 w-20 animate-pulse rounded bg-surface-hover" />
        </div>
