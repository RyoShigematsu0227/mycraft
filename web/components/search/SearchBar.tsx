  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        autoFocus={autoFocus}
        className="w-full rounded-full border border-border bg-background py-3 pl-12 pr-10 text-sm placeholder-muted focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent dark:border-border dark:bg-surface dark:placeholder-muted"
      />
      {query && (
        <button
          onClick={handleClear}
