            ...
            <div className="mt-2 flex items-center gap-2">
              ...
              {depth < maxDepth && (
                <button
                  ...
                  className="flex items-center gap-1 rounded-full px-2 py-1 text-xs text-muted hover:bg-surface hover:text-orange-600 dark:text-muted dark:hover:bg-surface dark:hover:text-orange-400"
                >
