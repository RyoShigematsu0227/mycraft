            ...
            {filters.map((f) => {
              ...
              return (
                <button
                  ...
                  className={`relative z-10 flex flex-1 cursor-pointer items-center justify-center gap-1.5 whitespace-nowrap rounded-xl px-2 py-2.5 text-sm font-semibold transition-all duration-300 ${
                    isActive
                      ? 'text-white'
