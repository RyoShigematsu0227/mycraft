...
export default function WorldCard({
  ...
  return (
    ...
    >
      ...
      <div className="absolute -right-20 -top-20 h-40 w-40 rounded-full bg-accent-light blur-3xl transition-all duration-500 group-hover:scale-150" />
        ...
        <div className="min-w-0 flex-1">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
            <div className="min-w-0">
              <span className="block text-lg font-bold text-gray-900 transition-colors group-hover:text-accent dark:text-gray-100 sm:truncate">
                {world.name}
              </span>
